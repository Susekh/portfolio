...
document.addEventListener("click", (event)=>{
    ...
    if (!isClickInsideNavbar && !isClickOnToggleButton) closeNavBar();
});
...
const contentData = [
    {
        imgSrc: "/Screenshot_20240420_011401.a75d83eb.png",
        title: "TEAMSYNC",
        pg: "01",
        index: "3"
    },
    {
        imgSrc: "./Screenshot_20240420_061046.81e2a5d3.png",
        title: "CAFFEE",
        pg: "02",
        index: "4"
    },
    {
        imgSrc: "./Screenshot_20240421_084352.5c5af00c.png",
        title: "WALDO",
        pg: "03",
        index: "5"
    }
...
function handleScroll() {
    ...
    if (scrollY < threshold1) updateContent(0);
    else if (scrollY >= threshold1 && scrollY < threshold2) updateContent(1);
    else if (scrollY >= threshold2) updateContent(2);
}
...
workTimeline.from(".work-div-1 > div > h3", {
    opacity: 0,
    y: 100
}).from(".work-div-2-txts > p:first-child", {
    opacity: 0,
    y: 100
});
